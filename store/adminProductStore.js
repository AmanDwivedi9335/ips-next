	...
	fetchProducts: async () => {
       ...
       addProduct: async (productData) => {
               try {
                       ...
                       const specialNote =
                               typeof productData.specialNote === "string"
                                       ? productData.specialNote.trim()
                                       : "";
        ...
        updateProduct: async (productId, updateData) => {
                try {
                       ...
                       if (updateData.productCode)
                        ...
                        const specialNote =
                                typeof updateData.specialNote === "string"
                                        ? updateData.specialNote.trim()
                                        : "";
                        formData.append("specialNote", specialNote);
